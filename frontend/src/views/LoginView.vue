  ...
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
    ...
    />
      ...
      <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-6 sm:p-8 mb-8 max-w-sm sm:max-w-md mx-auto">
        <h2 class="mb-8 text-center text-2xl font-bold text-gray-900 dark:text-gray-100">Login</h2>
      ...
      <form @submit.prevent="handleLogin">
        <div class="mb-5">
          <label for="username" class="block mb-2 font-medium text-gray-700 dark:text-gray-300">Username</label>
          <input
            id="username"
