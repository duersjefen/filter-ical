  ...
  <div v-if="hasAnyCategories" class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 mb-4 overflow-hidden">
    ...
    <div v-if="showCategoriesSection" class="p-3 sm:p-4">
      ...
      <div class="flex flex-wrap gap-2 justify-center mb-4 px-1">
        ...
        >
          <span class="hidden sm:inline">{{ showSelectedOnly ? '👁️ ' + $t('eventTypes.showAllCategories') : '🎯 ' + $t('eventTypes.showSelectedOnly') }}</span>
      ...
      <div class="mb-4 relative">
        <input 
          ...
          type="text" 
          :placeholder="$t('searchEventTypes')"
            ...
            <div class="flex-1 min-w-0">
              <div class="flex items-center justify-between gap-2">
                ...
                <span class="flex-shrink-0 px-2 py-1 bg-blue-100 dark:bg-blue-900/50 text-blue-800 dark:text-blue-300 text-xs rounded-full font-medium">
                  <span class="hidden sm:inline">{{ $t('eventTypes.singleEventsCount', { count: category.count }) }}</span>
      ...
      >
        ...
        <p class="text-sm text-gray-600 dark:text-gray-400">
          {{ searchTerm.trim() 
            ...
            : $t('eventTypes.selectCategoriesFirst') }}
        </p>
      </div>
      ...
      >
        ...
        >
          <div class="flex items-center gap-3">
            ...
            <span class="font-semibold text-purple-800 dark:text-purple-300">📄 {{ $t('eventTypes.singleEventCategories') }}</span>
